...
class ReportManager:
    ...
    def __init__(
        ...
        self._log_dir = None
        self._log_dir = self.testbench_manager.runtime_manager.data_dir / "recordings"
        if not os.path.exists(self._log_dir):
            os.makedirs(self._log_dir, exist_ok=True)
        logger.debug("Recordings directory set to: %s", self._log_dir)
        self.archives = []
